...
var Kalendae = function (targetElement, labelID, options) {
	...
	util.addEvent($container, 'mousedown', function (event, target) {
		...
		//DAY CLICK
			...
			label.innerHTML = self.getSelected();
			return false;
...
//        _weekdaysMin : "Su_Mo_Tu_We_Th_Fr_Sa".split("_"),
    ...
    ************************************/
    ...
    function makeDateFromInput(config) {
        ...
        if (input === undefined) {
        	var min='2013-01-01 00:00:00';
        	var mindata =new   Date(Date.parse(min.replace(/-/g,   "/")));
        	config._d = mindata;
            //config._d = new Date();
        } else if (matched) {
